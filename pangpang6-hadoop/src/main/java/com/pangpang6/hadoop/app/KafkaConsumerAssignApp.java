...
public class KafkaConsumerAssignApp {
    ...
    static class MyConsumer implements Runnable {
        ...
        public void run() {
            ...
            consumer.assign(Arrays.asList(new TopicPartition(KafkaConstant.TOPIC_BIGDATA_LIBRA_LOG, partition)));
            while (true) {
                ...
                while (iterator.hasNext()) {
                    ...
                    String content = String.format("Assign: partition: %s, offset: %s, value: %s",
